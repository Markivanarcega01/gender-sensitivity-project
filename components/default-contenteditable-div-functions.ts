...
export function createModal(suggestedWords, wordElement) {
...
export function modal(suggestedWords, wordElement) {  
...
export function highlightedWordListener(text, words, cursorPosition) {
